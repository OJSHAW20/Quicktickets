...
export default function FaqsPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl p-6 space-y-6 mt-20">
      ...
      {/* Intro blue box */}
      <div className="bg-blue-100 border-2 border-black rounded-lg p-4">
      ...
      <div className="space-y-1">
        {faqs.map((item, idx) => (
          <div key={idx}>
            <div
              className="bg-gray-300 border-2 border-black rounded-lg flex justify-between items-center px-4 py-2 cursor-pointer transition-all duration-200 hover:bg-gray-400"
            ...
            >
              <div className="bg-white border-2 border-t-0 border-black rounded-b-lg px-4 py-3">
      ...
      <div className="bg-blue-100 border-2 border-black rounded-lg p-4 space-y-2">
